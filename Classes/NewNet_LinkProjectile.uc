/*******************************************************************************
 * NewNet_LinkProjectile generated by Eliot.UELib using UE Explorer.
...
simulated function FakeInterp(float dt)
{
    ...
    {
        DoMove(((0.250 - OldDeltaFakeTime) / dt) * V);
        bInterpFake = false;
    }
    //return;    
}
